    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <h1 class="my-4" style="color:#002699;">“TRAVEL IS THE ONLY THING YOU BUY THAT MAKES YOU RICHER.”
            <small style="color:#002699;">-</small>
          </h1>
          <br><br>
            ...
            <div class="card-footer text-muted">
              ...
              <a href="<?php echo $userlink.$data["User_ID"]; ?>" style="text-transform: capitalize;"><?php 
                if(!isset($_SESSION["id"])){
                  ...
                  ?></a>
                <span class="badge badge-pill badge-info" style="float: right;"><?php echo ucfirst($data["Place"]); ?></span>
            </div>
          </div>
          <?php } } ?>
        </div>
